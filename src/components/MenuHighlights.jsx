...
import MenuDeckCard from './MenuDeckCard'
                  ...
                  {activeDeckOrder.map((itemIndex, depth) => {
                    ...
                    return (
                      <MenuDeckCard
                        ...
                        categoryCardPresenceVariants={categoryCardPresenceVariants}
                        textWidth={textWidth}
                        measuredHeight={measuredHeight}
                        isTopCard={isTopCard}
                        activeThrow={activeThrow}
                        isTopCardFlipped={isTopCardFlipped}
                        handleDeckDragEnd={handleDeckDragEnd}
                        handleTopCardPointerDown={handleTopCardPointerDown}
                        handleTopCardPointerMove={handleTopCardPointerMove}
                        handleTopCardPointerRelease={handleTopCardPointerRelease}
                        isPointerOverTopCardRef={isPointerOverTopCardRef}
                        wheelDeltaRef={wheelDeltaRef}
                        animateConfig={animateConfig}
                        transitionConfig={transitionConfig}
                        completeDeckCycle={completeDeckCycle}
